...
import { VectorLogo } from "./ui/Logo"
...
const Footer = ({
  ...
  return (
    <footer className={`${!mobile ? "hidden md:block" : ""}`}>
      {showBusiness && (
        <>
          <div className="bg-primary text-white">
            <div className="max-w-[850px] px-4 mx-auto flex gap-8 flex-col md:flex-row justify-center md:justify-evenly items-center py-8">
              <div className="w-full flex gap-16 items-center justify-center md:justify-start">
                <div className="hidden md:block">
                  <GraphVectorImage />
                </div>
                <div className="flex flex-col items-center md:items-start">
                  <span className="text-primary-lg font-bold">
                    Wyróżnij się jako firma!
                  </span>
                  <span className="font-bold text-xl">
                    Poznaj ofertę OLX dla biznesu
                  </span>
                </div>
              </div>
              <Link href="https://www.biznes.olx.pl">
                <a>
                  <WhiteButton width="w-max">Zobacz szczegóły</WhiteButton>
                </a>
              </Link>
            </div>
          </div>
          <div className="bg-lightAqua">
            <div className="max-w-[850px] px-4 py-16 mx-auto flex flex-col gap-16 items-center justify-center text-center">
              <div>
                <VectorLogo />
              </div>
              <p className="text-sm">
                OLX.pl to darmowe ogłoszenia lokalne w kategoriach: Moda,
                Zwierzęta, Dla Dzieci, Sport i Hobby, Muzyka i Edukacja. Szybko
                znajdziesz tu ciekawe ogłoszenia i łatwo skontaktujesz się z
                ogłoszeniodawcą. Na OLX.pl czeka na Ciebie praca biurowa,
                mieszkania, pokoje, samochody. Jeśli chcesz coś sprzedać - w
                prosty sposób dodasz bezpłatne ogłoszenia. Chcesz coś kupić -
                tutaj znajdziesz ciekawe okazje, taniej niż w sklepie.
                Sprzedawaj po sąsiedzku na OLX.pl
              </p>
              <div>
                <span className="text-sm">Dołącz do nas:</span>
                <ul className="flex gap-4 mt-4 opacity-75">
                  <li>
                    <Link href="#">
                      <a>
                  ...
                  <li>
                    <Link href="#">
                      <a>
                        <FaYoutubeSquare className="w-12 h-12" />
                      </a>
                    </Link>
                  </li>
                  <li>
                  ...
                  <li>
                    <Link href="#">
                      <a>
                        <FaPinterest className="w-12 h-12" />
                      </a>
                    </Link>
                  </li>
                </ul>
      ...
      <div className="border-t-[1px] border-primary mt-8 pt-8">
        <div className="container mx-auto">
          <div className="flex flex-col md:flex-row gap-8 items-center md:items-start justify-evenly">
            <ul className="font-bold flex flex-col items-center md:items-start gap-2">
              <li>
                <Link href="#">
                  <a>Aplikacje mobilne OLX.pl</a>
                </Link>
              </li>
              <li>
                <Link href="#">
            ...
            <ul className="font-bold flex flex-col items-center md:items-start gap-2">
              <li>
                <Link href="#">
                  <a>Jak działa OLX.pl</a>
                </Link>
              </li>
              <li>
                <Link href="#">
                  <a>Zasady bezpieczeństwa</a>
                </Link>
              </li>
              <li>
                <Link href="#">
              ...
              <li>
                <Link href="#">
                  <a>Mapa miejscowości</a>
                </Link>
              </li>
              <li>
                <Link href="#">
                  <a>Popularne wyszukiwania</a>
                </Link>
              </li>
              <li>
                <Link href="#">
    ...
    >
      <defs>
        <linearGradient id="a" x1="50%" x2="50%" y1="0%" y2="100%">
          <stop offset="0%" stopColor="#1E79AF"></stop>
          <stop offset="100%" stopColor="#63FFD3"></stop>
        </linearGradient>
        <linearGradient
          id="b"
          x1="84.718%"
          ...
          y2="77.661%"
        >
          <stop offset="0%" stopColor="#DC4057"></stop>
          <stop offset="100%" stopColor="#9E36BB"></stop>
        </linearGradient>
        <linearGradient id="c" x1="50%" x2="50%" y1="0%" y2="97.826%">
          <stop offset="0%" stopColor="#FF9676"></stop>
          <stop offset="100%" stopColor="#FFD074"></stop>
        </linearGradient>
        <linearGradient id="d" x1="17.444%" y1="20.298%" y2="79.702%">
          <stop offset="0%" stopColor="#51C6AD"></stop>
          <stop offset="100%" stopColor="#D5FFA1"></stop>
        </linearGradient>
      </defs>
      <g fill="none" fillRule="evenodd">
        <rect width="140" height="47.5" fill="#FFF" rx="6"></rect>
        <path
          fill="url(#a)"
